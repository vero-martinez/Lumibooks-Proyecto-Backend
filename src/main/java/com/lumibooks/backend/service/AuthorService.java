 ...
 * Define las operaciones disponibles para administrar autores desde el panel de
 * administración,
 * así como para obtener información de autores desde la parte pública de la
 * aplicación.
 */
public interface AuthorService {
    ...
    /**
     * Obtiene una lista paginada de autores activos aplicando un filtro opcional
